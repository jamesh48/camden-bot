                      ...
                      <Box>
                        ...
                        <Box>
                          ...
                          >
                            <Typography>
                              Date:{" "}
                              {dayjs(apartmentResult.bestRentClosestToMoveIn?.moveInDate).format(
                                "M-DD-YYYY",
                              )}
                            </Typography>
                            <Typography>
                              Cost: ${apartmentResult.bestRentClosestToMoveIn?.monthlyRent}
                            </Typography>
                            <Typography>
                              Lease Term: {apartmentResult.bestRentClosestToMoveIn?.leaseTerm}{" "}
                              months
                            </Typography>
                          </Box>
                        </Box>
